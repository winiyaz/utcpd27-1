# This is just like for version 1 , but you also adding a button to open webpage
import webbrowser
from tkinter import *
...
def open_webpage():
	webbrowser.open('https://megasite.meanworld.com/trailers/2455_nataliastarr_iyf.mp4')


# Button to open a webpage
webpage_button = Button(text="Open Webpage", bg="black", fg="white", font=("Arial", 20), command=open_webpage)
webpage_button.grid(column=2, row=4, pady=20)
